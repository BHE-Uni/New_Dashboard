                    ...
                    <div class="row pb-3">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="btn-group  mb-2 me-3" role="group">
                                <button id="btndefault" type="button" class="btn btn-outline-dark dropdown-toggle py-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="21" viewBox="0 0 18 21" fill="none">
                                    <g clip-path="url(#clip0_507_472)">
                                      <path d="M5.9375 1.59116C5.9375 1.07162 5.51953 0.653656 5 0.653656C4.48047 0.653656 4.0625 1.07162 4.0625 1.59116V3.15366H2.5C1.12109 3.15366 0 4.27475 0 5.65366V6.27866V8.15366V18.1537C0 19.5326 1.12109 20.6537 2.5 20.6537H15C16.3789 20.6537 17.5 19.5326 17.5 18.1537V8.15366V6.27866V5.65366C17.5 4.27475 16.3789 3.15366 15 3.15366H13.4375V1.59116C13.4375 1.07162 13.0195 0.653656 12.5 0.653656C11.9805 0.653656 11.5625 1.07162 11.5625 1.59116V3.15366H5.9375V1.59116ZM1.875 8.15366H15.625V18.1537C15.625 18.4974 15.3438 18.7787 15 18.7787H2.5C2.15625 18.7787 1.875 18.4974 1.875 18.1537V8.15366Z" fill="#98A2B3"/>
                                    </g>
                                    <defs>
                                      <clipPath id="clip0_507_472">
                                        <rect width="17.5" height="20" fill="white" transform="translate(0 0.653656)"/>
                                      </clipPath>
                                    </defs>
                            ...
                            <div class="btn-group  mb-2 me-3" role="group">
                                <button id="btndefault4" type="button" class="btn btn-outline-dark dropdown-toggle py-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="21" viewBox="0 0 15 21" fill="none">
                                    <g clip-path="url(#clip0_526_59)">
                                      <path d="M2.5 2.52866C2.15625 2.52866 1.875 2.80991 1.875 3.15366V18.1537C1.875 18.4974 2.15625 18.7787 2.5 18.7787H5.625V16.2787C5.625 15.2435 6.46484 14.4037 7.5 14.4037C8.53516 14.4037 9.375 15.2435 9.375 16.2787V18.7787H12.5C12.8438 18.7787 13.125 18.4974 13.125 18.1537V3.15366C13.125 2.80991 12.8438 2.52866 12.5 2.52866H2.5ZM0 3.15366C0 1.77475 1.12109 0.653656 2.5 0.653656H12.5C13.8789 0.653656 15 1.77475 15 3.15366V18.1537C15 19.5326 13.8789 20.6537 12.5 20.6537H2.5C1.12109 20.6537 0 19.5326 0 18.1537V3.15366ZM3.4375 4.71616C3.4375 4.37241 3.71875 4.09116 4.0625 4.09116H5.9375C6.28125 4.09116 6.5625 4.37241 6.5625 4.71616V6.59116C6.5625 6.93491 6.28125 7.21616 5.9375 7.21616H4.0625C3.71875 7.21616 3.4375 6.93491 3.4375 6.59116V4.71616ZM9.0625 4.09116H10.9375C11.2812 4.09116 11.5625 4.37241 11.5625 4.71616V6.59116C11.5625 6.93491 11.2812 7.21616 10.9375 7.21616H9.0625C8.71875 7.21616 8.4375 6.93491 8.4375 6.59116V4.71616C8.4375 4.37241 8.71875 4.09116 9.0625 4.09116ZM3.4375 9.71616C3.4375 9.37241 3.71875 9.09116 4.0625 9.09116H5.9375C6.28125 9.09116 6.5625 9.37241 6.5625 9.71616V11.5912C6.5625 11.9349 6.28125 12.2162 5.9375 12.2162H4.0625C3.71875 12.2162 3.4375 11.9349 3.4375 11.5912V9.71616ZM9.0625 9.09116H10.9375C11.2812 9.09116 11.5625 9.37241 11.5625 9.71616V11.5912C11.5625 11.9349 11.2812 12.2162 10.9375 12.2162H9.0625C8.71875 12.2162 8.4375 11.9349 8.4375 11.5912V9.71616C8.4375 9.37241 8.71875 9.09116 9.0625 9.09116Z" fill="#98A2B3"/>
                                    </g>
                                    <defs>
                                      <clipPath id="clip0_526_59">
                                        <rect width="15" height="20" fill="white" transform="translate(0 0.653656)"/>
                                      </clipPath>
                                    </defs>
                            ...
                            <div class="btn-group  mb-2 me-3" role="group">
                                <button id="btndefault4" type="button" class="btn btn-outline-dark dropdown-toggle py-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" viewBox="0 0 16 19" fill="none">
                                    <g clip-path="url(#clip0_526_148)">
                                      <path d="M1.6875 1.49741C1.6875 1.02983 1.31133 0.653656 0.84375 0.653656C0.376172 0.653656 0 1.02983 0 1.49741V2.90366V12.9759V14.7162V17.8099C0 18.2775 0.376172 18.6537 0.84375 18.6537C1.31133 18.6537 1.6875 18.2775 1.6875 17.8099V14.2943L4.51055 13.5876C5.95547 13.2255 7.48477 13.3943 8.81719 14.0587C10.3711 14.8357 12.1746 14.9306 13.7988 14.3189L15.0188 13.8619C15.4582 13.6966 15.75 13.2783 15.75 12.8072V2.97748C15.75 2.16889 14.8992 1.64155 14.175 2.00366L13.8375 2.17241C12.2098 2.98803 10.2937 2.98803 8.66602 2.17241C7.43203 1.55366 6.01523 1.39897 4.67578 1.73295L1.6875 2.48178V1.49741ZM1.6875 4.22202L5.08359 3.37123C6.03281 3.13569 7.03477 3.24467 7.91016 3.68061C9.84023 4.64389 12.0832 4.72475 14.0625 3.91967V12.4205L13.2047 12.7404C12.0199 13.1833 10.7016 13.1165 9.56953 12.5505C7.875 11.7033 5.93789 11.4923 4.09922 11.9494L1.6875 12.554V4.22202Z" fill="#98A2B3"/>
                                    </g>
                                    <defs>
                                      <clipPath id="clip0_526_148">
                                        <rect width="15.75" height="18" fill="white" transform="translate(0 0.653656)"/>
                                      </clipPath>
                                    </defs>
                            ...
                            <div class="btn-group  mb-2 me-3" role="group">
                                <button id="btndefault3" type="button" class="btn btn-outline-dark dropdown-toggle py-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                    <path d="M18.3119 14.8449V9.65428L18.46 9.56803C18.7744 9.38553 18.9619 9.05991 18.9619 8.69678C18.9619 8.33366 18.7744 8.00741 18.46 7.82491L10.8619 3.41116C10.2225 3.03866 9.42688 3.03928 8.7875 3.41116L1.18875 7.82553C0.875 8.00803 0.6875 8.33366 0.6875 8.69678C0.6875 9.05991 0.875 9.38553 1.18875 9.56866L3.4925 10.9074V14.0193C3.4925 14.7418 3.88125 15.4137 4.50625 15.7743L7.6775 17.6024C8.33938 17.9837 9.08187 18.1749 9.82438 18.1749C10.5669 18.1749 11.3087 17.9843 11.9712 17.6024L15.1419 15.7743C15.7675 15.4143 16.1562 14.7418 16.1562 14.0193V10.9068L17.1869 10.308V14.8449C16.9225 15.0249 16.7488 15.328 16.7488 15.6724C16.7488 16.2249 17.1969 16.673 17.7494 16.673C18.3019 16.673 18.75 16.2249 18.75 15.6724C18.75 15.3287 18.5763 15.0255 18.3119 14.8449ZM15.0319 14.0187H15.0312C15.0312 14.3399 14.8594 14.6387 14.5806 14.7987L11.41 16.6268C10.4325 17.1899 9.21688 17.1899 8.24 16.6268L5.06875 14.7987C4.79062 14.6387 4.61812 14.3399 4.61812 14.0187V11.5605L8.7875 13.983C9.1075 14.1687 9.46625 14.2618 9.825 14.2618C10.1838 14.2618 10.5425 14.1693 10.8625 13.983L15.0319 11.5605V14.0187ZM10.2969 13.0105C10.0056 13.1799 9.64375 13.1799 9.3525 13.0105L1.92813 8.69678L9.35188 4.38303C9.64312 4.21366 10.005 4.21366 10.2963 4.38303L17.7206 8.69616L10.2969 13.0105Z" fill="#98A2B3"/>
