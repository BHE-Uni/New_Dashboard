...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('src/plugins/css/light/apex/custom-apexcharts.css') }}">
    <link rel="stylesheet" href="{{ asset('src/plugins/css/dark/apex/custom-apexcharts.css') }}">
